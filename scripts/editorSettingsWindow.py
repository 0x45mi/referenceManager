...
from PySide2.QtWidgets import QDialog, QApplication, QRadioButton, QCheckBox, QVBoxLayout, QLabel, QSpacerItem, QSizePolicy, QFrame, QLineEdit
from PySide2.QtCore import Qt, Signal, QTimer
from PySide2.QtGui import QGuiApplication, QDoubleValidator
import styleSheet
    ...
    def cacheSwitch(self, checked: bool):
        ...
        for label in self.caching_options.findChildren(QLabel):
            for lineEdit in self.caching_widget.findChildren(QLineEdit):
                if self.cachingCheckbox.checkState() == False:
